        ...
        <div className="frame-6">
            ...
            <div className="GM-typography-2">
              <div className="frame-8">
                <div className="name-title-2">
                  <div className="text-wrapper-40">Mr. Ojerinde Emmanuel</div>
          ...
          <div className="frame-10">
            <p className="follow-mr-ojerinde">
              <span className="text-wrapper-42">Follow</span>

              <span className="text-wrapper-43">&nbsp;</span>

              <span className="text-wrapper-44">Mr. Ojerinde Emmanuel</span>
            </p>
            ...
            <div className="social-media-3">
              ...
              <FacebookLogo
                facebookLogo="/img/facebook-logo-21.svg"
              ...
              />
              <YoutubeLogo
                className="youtube-logo-5"
                img="/img/vector-89.svg"
                vector="/img/vector-88.svg"
                vectorClassName="youtube-logo-6"
                vectorClassNameOverride="youtube-logo-7"
              />
            </div>
          </div>
        </div>
