        ...
        <div className="frame-9">
            ...
            <div className="GM-typography-3">
              <div className="frame-11">
                <div className="name-title-3">
                  <div className="text-wrapper-9">Mr. Bada Munir Afolabi</div>
          ...
          <div className="frame-12">
            <p className="follow-mr-bada-munir">
              <span className="text-wrapper-11">Follow</span>

              <span className="text-wrapper-12">&nbsp;</span>

              <span className="text-wrapper-13">Mr. Bada Munir Afolabi</span>
            </p>

            <div className="social-media-3">
              <a
                className="instagram-logo-3"
              ...
              <FacebookLogo
                facebookLogo="/img/facebook-logo-6.svg"
                facebookLogoClassName="facebook-logo-3"
                href="https://facebook.com"
              />
              <a
                className="linkedin-logo-3"
              ...
              <TwitterLogo
                ...
                twitterLogoClassName="twitter-logo-3"
              />
              <YoutubeLogo
                className="youtube-logo-6"
                img="/img/vector-7.svg"
                vector="/img/vector-6.svg"
                vectorClassName="youtube-logo-7"
                vectorClassNameOverride="youtube-logo-8"
              />
            </div>
          </div>
        </div>
